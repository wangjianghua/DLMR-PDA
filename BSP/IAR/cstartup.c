...
extern  void  __initial_spTop     (void);
...
__root  const  APP_INTVECT_ELEM  __vector_table[] @ ".intvec" = {
    ...
    BSP_IntHandlerDMA2_CH6,                                     /* 84, INTISR[ 68]  DMA2 Channel 6 global Interrupt.    */
    BSP_IntHandlerDMA2_CH7,                                     /* 85, INTISR[ 69]  DMA2 Channel 7 global Interrupt.    */
    BSP_IntHandlerDMA2_CH8,                                     /* 86, INTISR[ 70]  DMA2 Channel 8 global Interrupt.    */
    ...
    BSP_IntHandlerOTG_HS_EP1_OUT,                               /* 90, INTISR[ 74]  OTG HS EP1 Output Interrupt.        */
    BSP_IntHandlerOTG_HS_EP1_IN,                                /* 91, INTISR[ 75]  OTG HS EP1 Input Interrupt.         */
    BSP_IntHandlerOTG_HS_WKUP,                                  /* 92, INTISR[ 76]  OTG HS Wakeup Interrupt.            */
    BSP_IntHandlerOTG_HS,                                       /* 93, INTISR[ 77]  OTG HS Interrupt.                   */
    BSP_IntHandlerDCMI,                                         /* 94, INTISR[ 78]  DCMI Interrupt.                     */
