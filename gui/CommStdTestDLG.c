...
#define ID_EDIT_0     (GUI_ID_USER + 0x87)
#define ID_EDIT_1     (GUI_ID_USER + 0x88)
#define ID_EDIT_2     (GUI_ID_USER + 0x89)
#define ID_EDIT_3     (GUI_ID_USER + 0x8A)
           ...
           if((Id >=  ID_EDIT_0) && (Id <=  ID_EDIT_3))
           {
            ...
            switch(((WM_KEY_INFO*)(pMsg->Data.p))->Key)
            {
                ...
                case '#':
                    ...
                    //WM_SetStayOnTop(g_hWin_msg, 1);
                    WM_BringToTop(g_hWin_msg);
                    WM_ShowWindow(g_hWin_msg);                    
                    WM_SetFocus(g_hWin_msg);
                    //WM_ValidateWindow(g_hWin_msg);
                    break;
              //规约调试页面的参数不需要保存
              //*****************************************
                case GUI_KEY_GREEN:
                    //para_store_edit(pMsg,ID_EDIT_1,std_Edit1_Text,10);//长度
                    //para_store_edit(pMsg,ID_EDIT_3,std_Edit3_Text,11);//数据域
                    //para_store_dropdown(pMsg,ID_DROPDOWN_0,12);//控制字
