...
//#define EDIT_FONT_DEFAULT &GUI_Font_Song_16

/*********************************************************************
*
*       Default font
*/
#define GUI_DEFAULT_FONT          &GUI_Font_Song_16
...
#define LCD_BASE           ((unsigned int)(0x60000000 | 0x04000000))
#define LCD_REF                ((LCD_TypeDef *) LCD_BASE)
