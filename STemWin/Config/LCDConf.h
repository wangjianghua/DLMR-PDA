...
#define LCD_PWR_OFF()         GPIO_SetBits(GPIOC, GPIO_PIN_7);
#define LCD_PWR_ON()          GPIO_ResetBits(GPIOC, GPIO_PIN_7);

#define LCD_BL_OFF()          GPIO_SetBits(GPIOC, GPIO_PIN_8)
#define LCD_BL_ON()           GPIO_ResetBits(GPIOC, GPIO_PIN_8)
