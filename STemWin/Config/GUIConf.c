...
//
#define GUI_NUMBYTES  0x8000   //32K //0x200000
...
extern GUI_CONST_STORAGE GUI_FONT GUI_Fontbold18;
...
void GUI_X_Config(void) {
  ...
  BUTTON_SetDefaultFont(GUI_DEFAULT_FONT);
  EDIT_SetDefaultFont(GUI_DEFAULT_FONT);
  DROPDOWN_SetDefaultFont(GUI_DEFAULT_FONT);
