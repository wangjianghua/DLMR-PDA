    ...
    switch(buff[4+Offset])    
    {
        ...
        case 0x02:
            if(Fn==1)
            {
             ...
             if(Info_ptr->bps==330)
                ...
                if(Info_ptr->bps==331)Frame_GDW3762CovPLC270_3D5(Frame_3762_Ptr->Data+6,0x02,GDW3762_App_Ptr->Data[0],(DL645_Frame_C *)(GDW3762_App_Ptr->Data+2));
             else
        ...
        case 0x05:
            ...
            if(Fn==3)//启功广播
            {
              ...
              if(Info_ptr->bps==330)
              Frame_GDW3762CovPLC270_3D5(PLC_Main_Addr,0x13,GDW3762_App_Ptr->Data[0],(DL645_Frame_C *)(GDW3762_App_Ptr->Data+2));
              else
		...
		if(Info_ptr->bps==10000)
		{
			GDW_RF_Protocol_2013(Frame_3762_Ptr->Data+6,Info_ptr->Lever,0x13,GDW3762_App_Ptr->Data[0],GDW3762_App_Ptr->Data+3,GDW3762_App_Ptr->Data[2],g_rf_buf);
                ...
                {
                    _sys_plc_reset();
                    Frame_GDW3762CovPLC270_3D5(Frame_3762_Ptr->Data+6,0x13,GDW3762_App_Ptr->Data[0],(DL645_Frame_C *)(GDW3762_App_Ptr->Data+3));
                }
             else
                if(Info_ptr->bps==329)
                {
